...
move ('N', n) (pos, dir) = (pos, dir + V2 0 n)
move ('S', n) (pos, dir) = (pos, dir + V2 0 (-n))
move ('E', n) (pos, dir) = (pos, dir + V2 n 0)
move ('W', n) (pos, dir) = (pos, dir + V2 (-n) 0)
...
solve :: Input -> Output
solve input =
  let (V2 x y, _) = foldl (flip move) (V2 0 0, V2 10 1) input
  in abs x + abs y
